...
<footer class="w3l-footer-66">
                  ...
                  <div class="row sub-content-botom mx-0">
                     <div class="col-md-4 footer-grid_section_w3layouts pl-lg-0">
                        ...
                        <ul class="footer list-unstyled">
                           ...
                           <li>
                              <a href="<?php echo RUTA; ?>views/about">Sobre Nosotros</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios">Servicios</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/contacto">Contacto</a>
                           </li>
                        </ul>
                     </div>
                     <div class="col-md-4 footer-grid_section_w3layouts">
                        ...
                        <ul class="footer list-unstyled">
                           ...
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=4">Odontología Preventiva</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=2">Odontología Infantil</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=7">Limpieza Bucal</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=10">Extracción de Dientes</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=3">Implantes Dentales</a>
                           </li>
                           <li>
                              <a href="<?php echo RUTA; ?>views/servicios/?id=8">Amalgamas</a>
                           </li>
   ...
   <div class="cpy-right py-3">
      <p class="text-center">© <?php echo date('Y'); ?> Dentiware Todos los derechos reservados</p>
   </div>
   <!-- move top -->

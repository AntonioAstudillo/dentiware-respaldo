...
<div class="content-wrapper">
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <table id="tablaCrearCita" class="table table-bordered  nowrap"  style = 'width:100%'>
               <thead  class="">
   ...
   <!-- MODAL -->
   <div id="cita" class="modal" tabindex="-1">
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-footer mt-2">
           ...
           <button type="button" class="btn btn-primary" id="btnGuardar" >Crear Cita</button>
         </div>
       </div>
     </div>
   </div>
...
<!-- MAIN -->
<script src="<?php echo RUTA; ?>js/admin/crearCita.js" charset="utf-8" type="module"></script>

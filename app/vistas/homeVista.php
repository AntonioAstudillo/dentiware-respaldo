							...
							<div class="banner-info">
								<div class="container">
									<div class="banner-info-bg">
										...
										<a class="btn mt-sm-5 mt-4" href="<?php echo RUTA; ?>/views/servicios">Mira nuestros servicios</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="card text-center">
						...
						<div class="open-description">
							...
							<a href="<?php echo RUTA; ?>views/servicios/?id=3">Leer más</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mt-md-0 mt-5 pt-md-0 pt-3">
					<div class="card text-center">
						...
						<div class="open-description">
							...
							<a href="<?php echo RUTA; ?>views/servicios/?id=4">Leer más</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mt-lg-0 mt-5 pt-lg-0 pt-3">
					<div class="card text-center">
						...
						<div class="open-description">
							...
							<a href="<?php echo RUTA; ?>views/servicios/?id=5">Leer más</a>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mt-lg-0 mt-5 pt-lg-0 pt-3">
					<div class="card text-center">
						...
						<div class="open-description">
							...
							<a href="<?php echo RUTA; ?>views/servicios/?id=1">Leer más</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="content-photo-grids row">
					...
					<div class="photo-6-inf-right col-lg-6 text-left pr-lg-5 mb-lg-0 mb-4">
						...
						<div class="servehny-1 mt-4">
							<div class="ser-sub">
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span>Familia y general odontología</a>
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span>Implantes dentales
								</a>
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span>Odontología cosmetica
								</a>
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span> Uso de la mejor calidad de instrumentos.</a>
							</div>
							<div class="ser-sub">
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span> Servicios dentales de emergencia</a>
								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span>Cirugía dental</a>

								<a href="<?php echo RUTA; ?>/views/servicios" class="ser1"><span class="fa fa-check"></span>Blanqueamiento de dientes</a>
							</div>
						</div>
						<div class="read">
							<a class="btn mt-4" href="<?php echo RUTA; ?>/views/servicios">Leer más</a>
						</div>
					</div>
					<div class="photo-6-inf-left col-lg-6 pr-lg-4">
						<a href="<?php echo RUTA; ?>/views/servicios"><img src="images/g1.jpg" class="img-fluid" alt=""></a>
					</div>
				</div>
			</div>
		</div>
	</section>
	<!-- trabajando para una nueva sonrisa  -->
   <?php require_once 'templates/bloque.php'; ?>
	<!-- //specification-6-->
					...
					<form id="formConsulta" autocomplete="off">
						<div class="admission-form">
							...
							<select id="tipoTratamiento" name="tipoTratamiento" class="form-select">
								<option value="ninguno">Tratamientos</option>
									...
									<div class="text-content">
										<div class="test-left">
											<div class="img-circle">
												<img src="images/c1.jpg" class="img-fluid testimonial-img"
													alt="client">
											</div>
											<div class="name">
							...
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="text-content">
										<div class="test-left">
											<div class="img-circle">
												<img src="images/c2.jpg" class="img-fluid testimonial-img"
													alt="client">
											</div>
											<div class="name">
												<h4>Sara De la O</h4>
							...
							<div class="item">
								<div class="slider-info mt-lg-4 mt-3">
									<div class="text-content">
										<div class="test-left">
											<div class="img-circle">
												<img src="images/c4.jpg" class="img-fluid testimonial-img"
													alt="client">
											</div>
											<div class="name">
												<h4>Gloria Leaño</h4>

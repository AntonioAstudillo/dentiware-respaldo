				...
				<div class="row">
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=1"><img src="<?php echo RUTA;?>images/g1.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								...
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=1">Leer más</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=2"><img src="<?php echo RUTA;?>images/g2.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								...
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=2">Leer más</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=3"><img src="<?php echo RUTA;?>images/g3.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								...
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=3">Leer más</a>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=4"><img src="<?php echo RUTA;?>images/g4.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								...
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=4">Leer más</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=5"><img src="<?php echo RUTA;?>images/g5.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								...
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=5">Leer más</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							<a href="servicio.php?id=6"><img src="<?php echo RUTA;?>images/g6.jpg" alt=" " class="img-fluid" /></a>
							<div class="service_grid_btm_left2">
								<h5>Blanqueamiento de dientes</h5>
								<p>El blanqueamiento hoy día, es uno de los servicios más solicitados en nuestra clínica.</p>
								<div class="read">
									<a class="btn mt-4" href="<?php echo RUTA; ?>views/servicios/?id=6">Leer más</a>
								</div>
							</div>
